...
@endif
    ...
    <!-- Main Content -->
    <div class="card">
        <button type="button" class="btn btn-primary mb-3" style="width: 150px;" data-bs-toggle="modal" data-bs-target="#modalTambah">Tambah
            Data</button>
            <form method="GET" action="{{ route('kamus.alphabet') }}" class="mb-3">
                        ...
                        <td>
                            ...
                            <div class="modal fade" id="fotoModal{{ $item->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="fotoModalLabel{{ $item->id }}">Foto -
                                                {{ $item->judul }}</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        ...
                                        <div class="modal-body text-center">
                                            @if ($item->gambar)
                                                <img src="{{ asset('storage/' . $item->gambar) }}"
                                                    alt="Foto {{ $item->judul }}" class="img-fluid rounded">
                                            @else
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header bg-danger text-white">
                                            <h5 class="modal-title" id="hapusModalLabel{{ $item->id }}">Konfirmasi
                                                Hapus</h5>
