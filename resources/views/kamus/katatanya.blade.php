...
@section('title', 'Kata Tanya - Bisik Tangan')

@section('header', 'Kata Tanya')
...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="staticBackdropLabel">Form Data Kata Tanya</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal"
                aria-label="Close"></button>
        </div>

            <form method="POST" action="{{ route('katatanya.store') }}" enctype="multipart/form-data">     
                @csrf
...
<tbody>
@forelse ($katatanya as $index => $item)
<tr>
...
<div class="modal-dialog">
<div class="modal-content">
<form action="{{ route('katatanya.update', $item->id) }}" method="POST" enctype="multipart/form-data">
@csrf
@method('PUT')
<div class="modal-header">
...
<div class="modal-footer">
<form action="{{ route('katatanya.destroy', $item->id) }}" method="POST">
@csrf
@method('DELETE')
