...
@section('title', 'Kata Kerja - Bisik Tangan')

@section('header', 'Kata Kerja')
...
<div class="card">
    ...
    <form method="GET" action="{{ route('kamus.katakerja') }}" class="mb-3">
...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="staticBackdropLabel">Form Data Kata Kerja</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal"
                aria-label="Close"></button>
        </div>

            <form method="POST" action="{{ route('katakerja.store') }}" enctype="multipart/form-data">     
                @csrf
...
<tbody>
@forelse ($katakerja as $index => $item)
<tr>
...
<div class="modal-dialog">
<div class="modal-content">
<form action="{{ route('katakerja.update', $item->id) }}" method="POST" enctype="multipart/form-data">
@csrf
@method('PUT')
<div class="modal-header">
<h5 class="modal-title" id="editModalLabel">Edit Data Kata Kerja</h5>
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
...
<div class="modal-footer">
<form action="{{ route('katakerja.destroy', $item->id) }}" method="POST">
@csrf
@method('DELETE')
